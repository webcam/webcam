...
class SimpleCaptcha
{
	...
	public $fonts = array(
		...
		'Jura'     => array('spacing' => -1, 'minSize' => 20, 'maxSize' => 28, 'font' => 'Jura.ttf'),
	...
	public function CreateImage($font = 'Jura') {
		$ini = microtime(true);
	...
	protected function WriteText($text, $fontcfg = array()) {
		...
		$fontfile = BASEPATH.'/fonts/'.$fontcfg['font'];
